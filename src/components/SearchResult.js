  ...
  if (type === TYPES.AUTHOR) {
    return (
      <View style={[styles.container, { backgroundColor: currentTheme.colors.background }]}>
        ...
        <Text style={[styles.description, {color: currentTheme.colors.text}]}>{data.description}</Text>
    ...
    return (
      <View style={[styles.container, { backgroundColor: currentTheme.colors.background }]}>
        <Text style={[styles.title, {fontSize: 16 } , {color: currentTheme.colors.text}]}>{data.name}</Text>
      </View>
    );
  } else if (type === TYPES.QUOTE) {
    return (
      <View style={[styles.container, { backgroundColor: currentTheme.colors.background }]}>
        <Text style={[styles.title, {fontSize: 14 } , {color: currentTheme.colors.text}]}>{data.content}</Text>
      </View>
    );
  }
}
